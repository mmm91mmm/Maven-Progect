...
<script>
				...
				<div class="container-fluid">
					<div class="collapse navbar-collapse" id="">
						<ul class="nav navbar-nav">
							...
							<li class="active"><a href="/admin/colour">Colour</a><span
	...
	<form:form action="/admin/colour" method="post" modelAttribute="colour">
	<form:hidden path="id"/>
	...
	<form:form action="/admin/colour" method="get" modelAttribute="filter">
		<c:forEach items="${param}" var="parameter">
			<c:forEach items="${parameter.value}" var="value">
	...
	<table>
		...
		<c:forEach items="${page.content}" var="colour">
			<tr>
				<td>${colour.name}</td>
				<td>
					<a href="/admin/colour/delete/${colour.id}?page=${page.number+1}&size=${page.size}&sort=${param['sort']}&search=${param['search']}">delete</a>
				</td>
				
				<td>
					<a href="/admin/colour/update/${colour.id}?page=${page.number+1}&size=${page.size}&sort=${param['sort']}&search=${param['search']}">update</a>
				</td>
			</tr>
		</c:forEach>	
		<tr>
